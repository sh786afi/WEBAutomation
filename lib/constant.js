...
var LOCATOR_Featured = {
  ...
  click_profile: element(
    by.xpath('//*[@id="headerCnt"]/div[3]/div/div[5]/div[5]/div/div[1]')
  ),
  click_myProfile: element(by.xpath('//*[@id="usersetting1"]/div/a[1]/div'))
};
var LOCATOR_Story = {
...
var LOCATOR_PROFILE = {
  click_add: element(
    by.xpath("//*[@class='profile-add-initial bolder mt_5 cursor_pointer']")
  ),
  click_changePhoto: element(by.xpath('//*[@id="forProfileImage"]')),
  click_savePic: element(by.xpath('//*[@id="btnSaveProf"]')),
  click_profileImg: element(
    by.xpath('//*[@id="profilePage"]/div[6]/div[1]/div[1]/div[4]')
  ),
  click_saveImgProfile: element(by.xpath('//*[@id="forProfileImage"]')),
  click_saveProImgButton: element(by.xpath('//*[@id="btnSaveProf"]')),
  click_deleteProPic: element(by.xpath('//*[@id="saveProfileOld"]/div[2]')),
  click_coverImg: element(by.xpath('//*[@id="profilePage"]/div[4]/div[3]')),
  upload_coverImg: element(by.xpath('//*[@id="forCoverImage"]')),
  save_coverImg: element(by.xpath('//*[@id="saveCover"]/div[2]')),
  delete_coverImg: element(by.xpath('//*[@id="saveCoverOld"]/div[2]')),
  close_profileImgWin: element(
    by.xpath('//*[@id="profilePicFull"]/div[1]/div[2]')
  )
};
